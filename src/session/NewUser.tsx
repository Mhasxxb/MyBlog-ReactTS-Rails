        ...
        <>
            <form
                ...
                <div className="space-y-6 my-7">
                    ...
                    <div className="flex justify-between items-center mx-20">
                        ...
                        <div className="relative w-80">
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer text-gray-500 hover:text-purple-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5" onClick={(): void => togglePasswordType()}>
                    ...
                    <div className="flex justify-between items-center mx-20">
                        ...
                        <div className="relative w-80">
                            ...
                            {/* 2. Position the SVG absolutely */}
                            <div className="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer text-gray-500 hover:text-purple-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5" onClick={(): void => toggleConfirmType()}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                </svg>
                            </div>
                ...
                <div className="text-center my-3">
                    ...
                    <p className="py-3 text-purple-800 text-shadow-lg/10 font-semibold">Already have an account <Link to="/login" className="font-extrabold text-purple-800/60 text-shadow-lg/10 hover:text-shadow-lg/15 transition-all" >login</Link> instead.</p>
                </div>
            </form>
        </>
    )
