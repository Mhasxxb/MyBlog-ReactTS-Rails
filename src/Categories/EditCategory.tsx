            ...
            <div>
                <div className="space-y-2 mt-9">
                    <div className="flex justify-between mx-20">
                        <label htmlFor="Title" className="text-purple-800 text-shadow-lg/10 font-semibold">Name: </label>
                        <input type="text" placeholder="Add a name" className="border-2 px-2 text-shadow-lg/5 text-purple-600/90 border-gray-400/50 rounded focus:outline-0 w-80 focus:border-purple-400" id="Username" />
                    </div>
                </div>
