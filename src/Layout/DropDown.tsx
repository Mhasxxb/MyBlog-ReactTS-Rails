...
function DropDown({ title, firstVal, secondVal, thirdVal }: ComponentType): JSX.Element {
  return (
    <div >
      <Menu>
        <MenuButton className="inline-flex items-center gap-2 rounded-md px-3 py-1.5 cursor-pointer text-sm/6 font-semibold text-purple focus:border-purple-900 shadow-purple  data-hover:text-white data-open:text-white">
          {title}
        ...
        <MenuItems
          transition
          anchor="bottom end"
          className="w-52 z-60 origin-top-right rounded-xl border border-purple/5 bg-purple/5 p-1 text-sm/6 text-purple bg-purple-900 transition duration-100 ease-out [--anchor-gap:--spacing(1)] focus:outline-none data-closed:scale-95 data-closed:opacity-0">
          <MenuItem>
